...
// CODE HERE
const evenNumbers = mixedNumbers.filter(mixedNumber => mixedNumber % 2 === 0)
...
// CODE HERE
const totalPopulation = populations.reduce((total, value) => total + value, 0)
...
// CODE HERE
let bobsTotal2 = purchases.filter(purchase => purchase.owner === 'Bob').reduce((a,c) => a + c.price, 0)
