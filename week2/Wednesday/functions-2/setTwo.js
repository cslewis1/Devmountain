...
/*
  ...
  callback function. Invoke the callback, passing in the product of the two numbers 
...
function each(names, cb) {
  names.forEach((element, i) => cb(element, i))
}
...
/*
  ...
  an array of objects (users), an id and a callback, and searches for the user with 
  a matching id.
  When the correct user object is found, invoke the callback with the user object as 
  an argument.
  You'll learn about objects in our next lecture. But you can research objects and attempt 
  this problem.
*/
