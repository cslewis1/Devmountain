...
//to showcase that we can use javascript functions
// and access data from testData
test("first name shoule be patten", () => {
...
describe('convert length tests', () => {
  test('convertLength returns an array with two items', () => {
